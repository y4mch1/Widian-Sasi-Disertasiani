<template> 
  <div ref="containerRef" class="h-screen w-full overflow-hidden relative" style="background-color: #F4A261;">
    <!-- Sticky Title -->
    <div 
      ...
      :style="{ 
        ...
        backgroundColor: currentSection > 0 ? '#F4A261' : 'transparent'
      }"
    >
...
const projectData = {
  title: "RECHEF",
  heroImage: new URL('@/assets/w2-1.jpg', import.meta.url).href,
  description: "Rechef is a food ingredient identification and recipe suggestion system powered by a fine-tuned MobileNetV2 model. The application can detect ingredients from food images and recommend relevant recipes, helping users discover new dishes easily and efficiently.",
  client: [
    "BANGKIT ACADEMY",
  ...
  teamImage: new URL('@/assets/w2.jpg', import.meta.url).href,
  responsibilitiesDescription:
    "In this project, I worked as a Machine Learning Engineer responsible for collecting and preparing the dataset through web scraping, fine-tuning the MobileNetV2 model for ingredient classification, and testing its performance. I focused on improving model accuracy and ensuring reliable prediction results for recipe recommendations."
}
