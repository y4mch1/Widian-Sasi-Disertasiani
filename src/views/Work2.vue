<template> 
  <div ref="containerRef" class="h-screen w-full overflow-hidden relative" style="background-color: #A8E6CF;">
    <!-- Sticky Title -->
    <div 
      ...
      :style="{ 
        ...
        backgroundColor: currentSection > 0 ? '#A8E6CF' : 'transparent'
      }"
    >
...
const projectData = {
  title: "ASA VR",
  heroImage: new URL('@/assets/w3 (1).png', import.meta.url).href,
  description: "Virtual Try On Website is a web-based application designed to allow users to try on clothes virtually. This project aims to provide an interactive and convenient experience for users to visualize how outfits look on them without the need for physical fitting.",
  client: [
  ...
  teamImage: new URL('@/assets/w3 (2).png', import.meta.url).href,
  responsibilitiesDescription:
    "In this project, I was responsible for designing and developing the user interface and front-end of the website. I also implemented API fetching for the virtual try-on model and integrated the system with Firebase to manage user data and image storage efficiently."
}
